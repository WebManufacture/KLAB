...
M = {
  Context : {},
  Element : null,
  url : "System._Modules.js",
  
  Init : function(){
    M.Element = W.tag("modules", "modules", "", W.Body);
    if (window.X != undefined){
    	M.Element.add("<module class='module processed' url='System._Ajax.js'></module>");
    }
    ...
    M.LoadModule("System._Modules.htm");   
  ...
  moduleLoaded : function(type, req){
    ...
    if (exp.test(data)){
      ...
      L.LogWarn("scripts reinjection: " + req.file);
    }
    module.html(data);
