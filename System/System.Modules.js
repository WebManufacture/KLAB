if (window.M == undefined || window.M == null || !window.M.IsOlmObject) {
    ...
    M = {
        ...
        LoadModule: function(ourl, module, cmod, cache) {
            ...
            AX.LoadModule(url, module, cache, M.moduleLoaded);
            return true;
        },
        ...
        moduleLoaded: function(result, result2) {
            try {
                var module = this.module;
                //var item = globalStorage['system.web-manufacture.net'].setItem("module:" + req.file, req.responseText);
                L.LogInfo('module: ' + this.url + ' from: ' + module.from, M.url, "modules module loaded");
                ...
                L.LogError(e, "System.Modules.js : moduleLoaded: " + this.url, "System.Modules.js");
            }
            M.ParseModule(module);
        },
